...
public static void main(String[] args) {
	...
	String heightToRide = JOptionPane.showInputDialog ("enter height in inches");
	...
	if(heightAsInt > 48 ) {
		JOptionPane.showMessageDialog(null, "Hurray! you can ride by yourself");
	}
		else if(heightAsInt>42){
		JOptionPane.showMessageDialog(null, "You can ride with someone else!");
		}
		else {
			JOptionPane.showMessageDialog(null, "your not tall enough to ride");
		}
